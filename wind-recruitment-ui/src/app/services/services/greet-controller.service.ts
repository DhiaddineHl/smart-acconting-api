...
import { sayHello } from '../fn/greet-controller/say-hello';
import { SayHello$Params } from '../fn/greet-controller/say-hello';

@Injectable({ providedIn: 'root' })
export class GreetControllerService extends BaseService {
  constructor(config: ApiConfiguration, http: HttpClient) {
    super(config, http);
  }

  /** Path part for operation `sayHello()` */
  static readonly SayHelloPath = '/hello';
